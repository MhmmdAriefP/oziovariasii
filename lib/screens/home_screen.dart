  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue, // Ganti warna AppBar di sini
        actions: [
          IconButton(
            onPressed: () {
              signOut(context);
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  SizedBox(height: 20),
                  Text('Tidak ada postingan tersedia'),
                ],
              ),
            );
          }
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Colors.deepOrangeAccent, // Ganti warna FloatingActionButton di sini jika diperlukan
      ),
    );
  }
}
